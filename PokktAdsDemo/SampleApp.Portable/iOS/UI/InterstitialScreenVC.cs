...
{
	partial class InterstitialScreenVC : UIViewController
	{
		string screenTitle;

		public InterstitialScreenVC (string screenName) : base ()
		{
		...
		public override void ViewDidLoad ()
		{
			...
			//Adding event
			PokktExtension.PokktAds.Interstitial.AdCachingCompletedEvent += AdCachingCompletedEvent;
			PokktExtension.PokktAds.Interstitial.AdCachingFailedEvent += AdCachingFailedEvent;
			PokktExtension.PokktAds.Interstitial.AdAvailabilityEvent += AdAvailabilityEvent;
			PokktExtension.PokktAds.Interstitial.AdDisplayedEvent += AdDisplayedEvent;
			PokktExtension.PokktAds.Interstitial.AdCompletedEvent += AdCompletedEvent;
			PokktExtension.PokktAds.Interstitial.AdClosedEvent += AdClosedEvent;
			PokktExtension.PokktAds.Interstitial.AdSkippedEvent += AdSkippedEvent;
			PokktExtension.PokktAds.Interstitial.AdGratifiedEvent += AdGratifiedEvent;
			PokktExtension.PokktAds.Interstitial.AdFailedToShowEvent += AdFailedToShowEvent;
		}

		partial void showNonRewarded_TouchUpInside(UIButton sender)
		{
			PokktAds.Interstitial.ShowNonRewarded(screenTitle);
		}

		partial void showRewarded_TouchUpInside(UIButton sender)
		{
			PokktAds.Interstitial.ShowRewarded(screenTitle);
		}

		partial void CacheRewarded_TouchUpInside(UIButton sender)
		{
			PokktAds.Interstitial.CacheRewarded(screenTitle);
		...
		{
			PokktAds.Interstitial.CacheNonRewarded(screenTitle);
