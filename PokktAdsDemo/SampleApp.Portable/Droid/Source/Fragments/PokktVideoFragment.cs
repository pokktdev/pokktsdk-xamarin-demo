...
{
    public class PokktVideoFragment : BaseFragment
    {
        // ui
        ...
        {
            View rootView = inflater.Inflate(Resource.Layout.fragment_pokkt_video, container, false);
        ...
        private void CacheRewarded(object sender, EventArgs e)
        {
            ...
            {
                PokktAds.VideoAd.CacheRewarded(edtScreenName.Text.Trim());
            }
        }
        ...
        private void ShowRewarded(object sender, EventArgs e)
        {
            ...
            if (isScreenNameSpecified())
            {
                PokktAds.VideoAd.ShowRewarded(edtScreenName.Text.Trim());
            }
        }
        ...
        private void CacheNonRewarded(object sender, EventArgs e)
        {
            ...
            if (isScreenNameSpecified())
            {
                PokktAds.VideoAd.CacheNonRewarded(edtScreenName.Text.Trim());
            }
        }
        ...
        private void ShowNonRewarded(object sender, EventArgs e)
        {
            ...
            if (isScreenNameSpecified())
            {
                PokktAds.VideoAd.ShowNonRewarded(edtScreenName.Text.Trim());
            }
        }
        ...
        // Implementaions of Actions subscribed for VideoAds

        private void AdCachingCompleted(String screenName, bool isRewarded, float reward)
        {
            if (this.Activity == null)
            {
                return;
            }
            Toast.MakeText(this.Activity, "Video Ad Caching Completed ! Ad vc is: " + reward, ToastLength.Short).Show();
        ...
        public void AdCachingFailed(String screenName, bool isRewarded, String errorMessage)
        {
            ...
            Toast.MakeText(this.Activity, "Video Ad Download Error " + errorMessage, ToastLength.Short).Show();
            if (edtScreenName.Text.Trim().Equals(screenName))
            {
                HideProgress();
            }
        ...
        public void AdDisplayed(String screenName, bool isRewarded)
        {
            ...
            Toast.MakeText(this.Activity, "Video Ad Displayed", ToastLength.Short).Show();
        }
        ...
        public void AdFailedToShow(String screenName, bool isRewarded, String errorMessage)
        {
            ...
            Toast.MakeText(this.Activity, "Video Ad Show Error " + errorMessage, ToastLength.Short).Show();
            HideProgress();
        }
        ...
        public void AdClosed(String screenName, bool isRewarded)
        {
            ...
            HideProgress();
            Toast.MakeText(this.Activity, "Video Ad Closed", ToastLength.Short).Show();
        }
        ...
        public void AdSkipped(String screenName, bool isRewarded)
        {
            ...
            HideProgress();
            Toast.MakeText(this.Activity, "Video Ad Skipped", ToastLength.Short).Show();
        }
        ...
        public void AdCompleted(String screenName, bool isRewarded)
        {
            ...
            HideProgress();
            txtEarnedPoints.Text = GetString(Resource.String.txt_earned_points).Replace("%s", Convert.ToString(PokktStorage.GetVideoPoints(this.Activity)));
            Toast.MakeText(this.Activity, "Video Ad Completed", ToastLength.Short).Show();
        }
        ...
        public void AdAvailabilityStatus(String screenName, bool isRewarded, bool availability)
        {
            ...
            if (availability)
            {
                Toast.MakeText(this.Activity, "Video Ad is Available", ToastLength.Short).Show();
            }
            else
            {
                Toast.MakeText(this.Activity, "Video Ad is not Available", ToastLength.Short).Show();
            }
        }
    }
}